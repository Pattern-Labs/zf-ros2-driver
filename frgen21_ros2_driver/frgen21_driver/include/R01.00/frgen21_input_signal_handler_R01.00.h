#include "R01.00/RxSignalHandler_Cfg_Cmp_R01.00.h"
...
class InputSignalHandlerR01_00 : public InputSignalHandler {
public:
  InputSignalHandlerR01_00(const std::string &remote_ip, int remote_port,
                           int local_port);
