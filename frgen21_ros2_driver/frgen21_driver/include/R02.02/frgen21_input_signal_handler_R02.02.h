#include "R02.02/RxSignalHandler_Cfg_Cmp_R02.02.h"
...
class InputSignalHandlerR02_02 : public InputSignalHandler {
public:
  InputSignalHandlerR02_02(const std::string &remote_ip, int remote_port,
                           int local_port);
