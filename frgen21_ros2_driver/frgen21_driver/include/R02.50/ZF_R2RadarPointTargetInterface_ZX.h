...
namespace ZF_FRGen21_PTL_Interface_ZX_R02_50 {
...
TYPEDEF_PACKED_BEGIN(struct,
  ...
  Struct_ZX_If4Eth_GenericTypes_COMPLEX_t
      sDynCalibCoeffs[SizeOfBlockagePackagesValues];
  uint32_t sOPE_inactive_cnt; /**< Online Phase Estimation number of cycles last
                                 OPE was executed successfully */
  uint8_t sOPE_num_targets; /**< Online Phase Estimation number of targets used
                               for last calculation         */
  uint8_t sOPE_avg_confidence; /**< Online Phase Estimation average confidence
                                  for sorting */
  uint16_t sOPE_max_range;     /**< Online Phase Estimation max range (m)     */
  uint16_t sOPE_min_range;     /**< Online Phase Estimation min range (m) */
  uint32_t CRC;
}
Struct_ZX_Itf4Eth_Payload_Blockage_Dyn_Coeff_OPE_t;
TYPEDEF_PACKED_END
...
TYPEDEF_PACKED_BEGIN(struct, struct_ZX_Itf4Eth_Primary_Data) {
  ...
  Struct_ZX_Itf4Eth_Payload_Blockage_Dyn_Coeff_t sBlockageDynCoeffs;
  Struct_ZX_Itf4Eth_Payload_Blockage_Dyn_Coeff_OPE_t sBlockageDynCoeffsOPE;
  uint8_t
